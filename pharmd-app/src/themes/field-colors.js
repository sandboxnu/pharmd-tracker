...
export const getFieldColor = ({record, source}) => getFieldColorValue(getFieldColorName({record, source}));

// get color value for the given field
export const getFieldBackgroundColor = ({record, source}) => getFieldBackgroundColorValue(getFieldColorName({record, source}));
...
export const getFieldBackgroundColorValue = (colorName) => getFieldColorValue(colorName).replace("1)", "0.3)");
